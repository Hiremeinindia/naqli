...
class EquipmentUnits extends StatefulWidget {
  const EquipmentUnits({
    Key? key,
  }) : super(key: key);

  @override
  State<EquipmentUnits> createState() => _EquipmentUnitsState();
}

class _EquipmentUnitsState extends State<EquipmentUnits> {
